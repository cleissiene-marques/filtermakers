...
export const metadata: Metadata = {
  ...
  description:
    "Tire suas dúvidas sobre teste grátis, velocidade de internet, aparelhos compatíveis, preços, pagamento, fidelidade e suporte da Filter Makers IPTV.",
  alternates: { canonical: "/faq/" },
  openGraph: {
    url: "/faq/",
    title: "Perguntas Frequentes sobre IPTV | Filter Makers IPTV",
    description:
      "Tire suas dúvidas sobre teste grátis, velocidade de internet, aparelhos compatíveis, preços, pagamento, fidelidade e suporte da Filter Makers IPTV.",
  },
  twitter: {
  ...
  return (
    <>
      ...
      <section className="section" aria-labelledby="faq-list-heading">
        <div className="container">
          <h2 className="section-heading" id="faq-list-heading" style={{ textAlign: "center" }}>Dúvidas rápidas sobre a Filter Makers IPTV</h2>
